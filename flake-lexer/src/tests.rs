...
fn keywords_and_identifiers() {
    let src = "fn let var if else while for loop in return break continue true false nil dyn type struct enum strict owned ref mut import as pub unsafe match spawn await nursery trait impl const foo _bar Baz_1";
